...
export const handlers = [
  ...
  http.post('http://74.226.194.15/api/auth/login', async ({ request }) => {
    ...
    return HttpResponse.json({ 
      token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..5pYsiQWKurpSRb1VNvu3xXsuqpctj2AiljQUmZSafbU" 
    }, { status: 200 });
  }),
]